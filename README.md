...
| `-y` \| `--yaml` | Treat configuration data as YAML (converts to/from JSON as necessary). The [yq](https://github.com/mikefarah/yq) tool is required for this option.
...
Options may be combined. For example, `edit --yaml` will open the
